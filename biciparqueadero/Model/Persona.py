class Persona:
    ...
    def __str__(self):
        return f'Nombre: {self._nombre}, Apellido: {self._apellido} , edad: {self._fecha_nacimiento}, Tipo de documento: {self._tipo_documento}, numero de documento:{self._numero_documento}'
